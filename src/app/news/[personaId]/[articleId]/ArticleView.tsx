...
import { Shield, Zap, MessageSquare, ChevronLeft, Share2, Clock, Calendar, BarChart3, Lock, Sparkles } from 'lucide-react';
import Image from 'next/image';
import Header from '@/components/Header';

export default function ArticleView({ article, profile, personaId, articleId }: any) {
         ...
         <div className="flex-1 space-y-12">
            <div className="flex items-center gap-4 p-6 bg-white/5 border border-white/10 rounded-3xl">
             ...
             <div className="prose prose-invert prose-lg max-w-none">
                <p className="text-xl md:text-2xl text-white/80 leading-relaxed italic font-light whitespace-pre-wrap">
                   {article.content}
                </p>
