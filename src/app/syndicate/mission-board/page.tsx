                ...
                <>
                    ...
                    <div className="text-center space-y-4">
                        ...
                        <h1 className="text-4xl md:text-6xl font-black italic tracking-tighter uppercase leading-none">
                            MISSION <span className="text-[#00fff2]">CENTER</span>
                        </h1>
...
export default function SyndicatePortalPage() {
    return (
        <main className="min-h-screen bg-black text-white relative overflow-hidden flex items-center justify-center p-4">
            ...
            <Suspense fallback={<div className="text-[#00fff2] animate-pulse font-black uppercase tracking-widest text-[8px]">Syncing Node...</div>}>
                <SyndicatePortalContent />
            </Suspense>
        </main>
    );
}
